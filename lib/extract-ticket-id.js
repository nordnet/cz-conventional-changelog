...
const extractTicketId = branchName => compose(toUpperCase, orValue(head, ''), getTicketIdMatch)(branchName);

const getBranchName = () => shell.exec('git symbolic-ref --short HEAD', {silent: true}).stdout;
